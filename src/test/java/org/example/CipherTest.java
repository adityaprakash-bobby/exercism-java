...
public class CipherTest {
    private final Cipher substitutionCipher = new Cipher("abcdefghij");
    ...
    public void randomKeyCipherCanDecode() {
        ...
        assertThat(randomKeyCipher.decode(randomKeyCipher.getKey().substring(0, 10))).isEqualTo(cipherText);
    }
